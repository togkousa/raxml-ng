...
use_holdout_es(false), split_ratio(DEF_SPLIT_RATIO), split_save_phylip(false), convergence_iterations(DEF_CONVERGENCE_ITERATIONS),
...
msa_file(""), training_msa_file(""), testing_msa_file(""), model_file(""), weights_file(""), outfile_prefix(""),
